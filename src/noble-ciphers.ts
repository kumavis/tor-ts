...
//     const iKeyP = cr.importKey('raw', key, keyParams, true, ['encrypt', 'decrypt']);

//     // !! increment counter
//     const incrementCounter = (blockCount: number) => {
//       const ivLength = cryptParams.counter.length
//       const numberLength = 6
//       const counterOffset = ivLength - numberLength
//       // console.log('counter before', (cryptParams.counter as Buffer).readUIntBE(counterOffset, numberLength))
//       const currentCounter = (cryptParams.counter as Buffer).readUIntBE(counterOffset, numberLength)
//       ;(cryptParams.counter as Buffer).writeUIntBE(currentCounter + blockCount, counterOffset, numberLength)
//       // console.log('counter after', (cryptParams.counter as Buffer).readUIntBE(counterOffset, numberLength))
//     }
...
//         const blockCount = Math.ceil(plaintext.length / keyLength)
...
//         const blockCount = Math.ceil(ciphertext.length / keyLength)
//         incrementCounter(blockCount);
...
// exports.makeKey = async function (key, iv) {
//   const cipher = createCipheriv('aes-128-ctr', key, iv)
//   return {
//     encrypt: async function (plaintextBuffer) {
//       const ciphertextBuffer = cipher.update(plaintextBuffer)
//       return ciphertextBuffer
//     },
//   }
// }

export const aes_128_ctr = (key: Uint8Array, nonce: Uint8Array) => {
