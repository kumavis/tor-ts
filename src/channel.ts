...
export async function performHandshake (connection: Connection, keyInfo: KeyInfo, peerCert: Buffer, supportedVersions: Array<number> = defaultLinkSupportedVersions) {
