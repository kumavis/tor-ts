...
function messageCellTypeCode(t: MessageCellType): bigint {
  switch (t.kind) {
    case 'PADDING':           return 0n;
    case 'CREATE':            return 1n;
    case 'CREATED':           return 2n;
    case 'RELAY':             return 3n;
    case 'DESTROY':           return 4n;
    case 'CREATE_FAST':       return 5n;
    case 'CREATED_FAST':      return 6n;
    case 'VERSIONS':          return 7n;
    case 'NETINFO':           return 8n;
    case 'RELAY_EARLY':       return 9n;
    case 'CREATE2':           return 10n;
    case 'CREATED2':          return 11n;
    case 'PADDING_NEGOTIATE': return 12n;
    case 'VPADDING':          return 128n;
    case 'CERTS':             return 129n;
    case 'AUTH_CHALLENGE':    return 130n;
    case 'AUTHENTICATE':      return 131n;
    case 'AUTHORIZE':         return 132n;
  }
}
...
function isVariableLengthCell(t: MessageCellType): boolean {
  switch (t.kind) {
    ...
    case 'VPADDING':       return true;
    case 'CERTS':          return true;
    case 'AUTH_CHALLENGE': return true;
    ...
    case 'CREATE_FAST':       return false;
    case 'CREATED_FAST':      return false;
    case 'NETINFO':           return false;
    case 'RELAY_EARLY':       return false;
    case 'CREATE2':           return false;
    case 'CREATED2':          return false;
    case 'PADDING_NEGOTIATE': return false;
  }
}
