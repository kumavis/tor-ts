...
test('KDF_RFC5869', (t) => {
  const keySeed1 = Buffer.from(
    hmac(sha256, Buffer.from(NtorParams.t_key, 'utf-8'), Buffer.from('Tor'))
  );
  const result1 = KDF_RFC5869(keySeed1, 100);
  t.is(
    result1.toString('hex'),
    '5521492a85139a8d9107a2d5c0d9c91610d0f95989975ebee6c02a4f8d622a6cfdf9b7c7edd3832e2760ded1eac309b76f8d66c4a3c4d6225429b3a016e3c3d45911152fc87bc2de9630c3961be9fdb9f93197ea8e5977180801926d3321fa21513e59ac',
    'KDF_RFC5869 result1 does not match'
  );
  ...
  t.is(
    ...
    'a2aa9b50da7e481d30463adb8f233ff06e9571a0ca6ab6df0fb206fa34e5bc78d063fc291501beec53b36e5a0e434561200c5f8bd13e0f88b3459600b4dc21d69363e2895321c06184879d94b18f078411be70b767c7fc40679a9440a0c95ea83a23efbf',
    'KDF_RFC5869 result2 does not match'
  );
});
