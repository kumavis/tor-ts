...
(Sweet berries stand in for tomatoes; milk stands in for cheese.)
...
tasty_treats_bp/                    Behavior pack (game logic)
  ...
  scripts/main.js                   itemCompleteUse -> effects table (ramen,
                                    ice cream, candy)
...
imported an older copy pick up the update (this pack is at 1.1.0).
...
- A placeable cake-style block version of the pizza (custom block + `bites`).
